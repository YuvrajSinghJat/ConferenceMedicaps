            ...
            <nav className="container mx-auto flex items-center justify-center flex-wrap bg-white pt-4 lg:pt-2">
                ...
                <Zoom>
                    <div className="w-full block flex-grow justify-center lg:flex lg:items-center lg:w-auto">
                        <p className="dispNone1 text-center sm:w-auto sm:text-[3.25rem] sm:font-black text-[#016698] font-bold startHeading12 supHeading  mt-4 headingMain font-extrabold">3rd International Conference on Computer,<br></br> Communication and Control<br></br>(IC4'26)<span className='text-[1.25rem] '><br></br>December 10-12, 2026</span>
                        </p>
                        <p className="dispNone2 text-center sm:w-auto sm:text-[3.25rem] sm:font-black text-[#016698] font-bold startHeading12 supHeading  mt-1 mx-2 headingMain font-extrabold">3rd International Conference on Computer,<br></br> Communication and Control <br></br> (IC4'26)<br /><span className='text-[0.7rem] '>December 10-12, 2026</span>
                        </p>
            ...
            <div className='w-full top-0 left-0 navClass '>
                <div className='md:flex items-center justify-center py-2 md:px-10 px-7 '>
                    ...
                    <ul className={`${props.type === 'homePage' ? 'dispNone' : null} md:flex items-center:flex md:items-center md:pb-0 pb-12 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 sm:pl-9 transition-all sideNav duration-500 ease-in navClass1 ${open ? 'top-[56px] ' : 'top-[-1100px]'}`} >
                        ...
                        <div className="flex justify-center items-center">
                            ...
                            <div className="flex md:ml-4 text-xl md:my-0 my-2 sm:mx-0 mx-4 justify-center dispNone1">
                                {/* <a href="https://cmt3.research.microsoft.com/ICEETA2025" target='_blank'> */}
                                    <button className="inline-block px-6 py-2 bg-[#016698] font-medium border-2 border-white text-white text-sm leading-tight uppercase rounded-lg hover:bg-[#293985] hover:border-2 hover:shadow-lg transition duration-150 ease-in-out ">Paper Submission</button>
                                {/* </a> */}
                            </div>

                            <div className="flex md:ml-4 text-xl md:my-0 my-2 sm:mx-0 mx-4 justify-center dispNone1">
                                <Link to='/register'><button type="button" className="inline-block px-6 py-2 bg-[#016698] font-medium border-2 border-white text-white text-sm leading-tight uppercase rounded-lg hover:bg-[#293985] hover:border-2  hover:border-[#016698] hover:shadow-lg transition duration-150 ease-in-out ">Register</button>
                                </Link>
                            </div>
                        ...
                        <a download="conferenceBrochure" target='_blank'><button type="button" className="inline-block px-4 py-2 bg-[#ff0000] font-medium border-2 border-white text-white text-sm leading-tight uppercase rounded-lg hover:bg-[#a21d2e] hover:border-2 hover:border-[#ff0000] hover:shadow-lg transition duration-150 ease-in-out "><i class="fa-solid fa-circle-down mr-2"></i>Brochure</button>
                                </a>
                            </div>
