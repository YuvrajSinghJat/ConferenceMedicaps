                ...
                <div className="container mx-auto flex px-5 py-12 items-center justify-center flex-col bg-[#E3F0FB]">
                    <Fade bottom>
                        ...
                        <div className="text-center lg:w-2/3 w-full">
                            ...
                            <p className="mb-4 leading-relaxed text-black font-semibold mt-12 text-sm sm:text-xl text-justify">Authors are invited to submit papers through the conference <span className='text-[#016698]'>Submission System</span> by <span className='text-[#016698] font-bold'><del style={{ textDecoration: "line-through", color: "red" }}><span className="text-[#016698]"></span></del><del style={{ textDecoration: "line-through", color: "red" }}><span className="text-[#016698]">May 30,2025 </span></del><br></br><span className="text-[#ff0000]"> June 15,2025</span>.</span> Submissions must be original and should not have been published previously or be under consideration for publication while being evaluated for this conference.</p>
                            <span className="inline-block h-1 w-24 rounded bg-[#016698] mt-8 mb-6"></span>
